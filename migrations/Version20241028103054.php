 ...
 */
final class Version20241028103054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT UNSIGNED AUTO_INCREMENT NOT NULL, user_id INT UNSIGNED NOT NULL, title VARCHAR(160) NOT NULL, article_description LONGTEXT NOT NULL, article_date_created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, article_date_published DATETIME DEFAULT NULL, article_published TINYINT(1) NOT NULL, title_slug VARCHAR(162) NOT NULL, text LONGTEXT NOT NULL, article_date_create DATETIME NOT NULL, article_date_articleed DATETIME DEFAULT NULL, published SMALLINT NOT NULL, INDEX IDX_23A0E66A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE article_tag (article_id INT UNSIGNED NOT NULL, tag_id INT UNSIGNED NOT NULL, INDEX IDX_919694F97294869C (article_id), INDEX IDX_919694F9BAD26311 (tag_id), PRIMARY KEY(article_id, tag_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE comment (id INT UNSIGNED AUTO_INCREMENT NOT NULL, article_id INT UNSIGNED NOT NULL, user_id INT UNSIGNED NOT NULL, comment_message VARCHAR(2500) NOT NULL, comment_date_created DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL, comment_published TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_9474526C7294869C (article_id), INDEX IDX_9474526CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
